...
OWNER = os.environ.get("OWNER", "Devil_Eyes_xe") # Owner username without @
...
#--------------------------------------------
START_PIC = os.environ.get("START_PIC", "https://i.postimg.cc/ydQqGps4/1756908658921.jpg")
FORCE_PIC = os.environ.get("FORCE_PIC", "https://i.postimg.cc/Pf0frNnG/c3f72293bd0fc0e41778d0741175bde1.jpg")

#--------------------------------------------
SHORTLINK_URL = os.environ.get("SHORTLINK_URL", "linkshortify.com")
SHORTLINK_API = os.environ.get("SHORTLINK_API", "")
VERIFY_EXPIRE = int(os.environ.get('VERIFY_EXPIRE', 20)) # Add time in seconds
TUT_VID = os.environ.get("TUT_VID","https://t.me/How_To_Download_Tutorial_xe/9")
